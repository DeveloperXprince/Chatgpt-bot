...
HELP_BACK = [
     [
           InlineKeyboardButton(text="Qᴜᴇꜱᴛɪᴏɴ ᴛʜᴀᴛ ᴄʜᴀᴛɢᴘᴛ ᴄᴀɴ ꜱᴏʟᴠᴇ ", url=f"https://t.me/detective_prince"),
...
if SOURCE != s:
    print("So sad, you have changed source, change it back to ` https://github.com/DeveloperXprince/Chatgpt-bot `  else I won't work")
    sys.exit(1)  
